 ...
 * format typically used in Gibloux Volley:
 * date and time:`dddd dd.mm.YYYY HH:mm`
 *
 ...
 jQuery.extend( jQuery.fn.dataTableExt.oSort, {
	"de_datetime-asc": function ( a, b ) {
		...
		if (jQuery.trim(a) !== '') {
			...
			var deTimea = deDatea[2].split(':');
			var deDatea2 = deDatea[1].split('.');
		...
		if (jQuery.trim(b) !== '') {
			...
			var deTimeb = deDateb[2].split(':');
			deDateb = deDateb[1].split('.');
